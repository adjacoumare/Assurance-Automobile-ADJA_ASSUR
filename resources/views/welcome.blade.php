...
<head>
  ...
  <title>Welcome to ADJA ASSUR</title>
...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
      <div class="align-items-center d-none d-md-flex">
        <i class="bi bi-clock"></i> Lundi - Vendredi, 08h00 - 17h00
      </div>
      <div class="d-flex align-items-center">
        <i class="bi bi-phone"></i> Appelez-nous maintenant +223 97774379
      </div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="#" class="logo me-auto"><img src="assets/img/logo.png" alt="">ADJA ASSUR</a>
    ...
    <section id="apropos" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Située à Hamdallaye ACI 2000 Place CAN, ADJA ASSUR est une agence d’assurance spécialisée dans la branche automobile. .</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Asssurance Automobile.</h3>
            <p class="fst-italic">
            Selon l’article 200 du Code CIMA, l’Assurance Automobile est obligatoire pour tout véhicule terrestre à moteur appartenant à toute personne autre l’Etat au sens du droit interne. Elle couvre la Responsabilité Civile du Conducteur contre les dommages causés aux tiers avec son véhicule (passagers, piétons, automobilistes). Si cette garantie constitue le minimum obligatoire, elle ne couvre ni les dommages corporels du conducteur, ni les dommages aux véhicules.
            </p>
            <p>POURQUOI SOUSCRIRE UNE ASSURANCE AUTOMOBILE ?
            L’assurance automobile permet d’indemniser les dommages causés aux tiers ainsi que ceux subis par votre véhicule dans toutes circonstances. Il existe deux types de garanties:
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> La Responsabilité Civile.</li>
              <li><i class="bi bi-check-circle"></i> Les dommages subis par votre véhicule auxquelles s’ajoutent diverses garanties complémentaires.</li>
            </ul>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>Notre Adresse</h3>
                  <p>Hamdallaye ACI2000, Place CAN</p>
                </div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>Appelez-nous</h3>
                  <p>+223 97774379<br>+223 91355895</p>
                </div>
              </div>
            </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              <h3>ADJA ASSUR</h3>
              <p>
                Hamdallaye ACI2000, Place CAN<br><br>
                <strong>Telephone:</strong> +223 97774379<br>
                <strong>Email:</strong> dcoumare99@gmail.com<br>
              </p>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Notre Bulletin</h4>
            <p>Cependant, s'il y a beaucoup de gens qui ne savent pas ce que je lis, alors je lirai notre grand défaut</p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Adja Assur</span></strong>. Tous les droits sont réservés
      </div>
      <div class="credits">
        ...
        <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/medicio-free-bootstrap-theme/ -->
            Conçu par <a href="https://bootstrapmade.com/">Djeneba COUMARE</a>
      </div>
    </div>
  </footer>
  <!-- End Footer -->
